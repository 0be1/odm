...
public final class DefaultConverters
{
	public static final ImmutableMap<String, Converter> defaultSyntaxConverters = new ImmutableMap.Builder<String, Converter>()
			...
			.put( "1.3.6.1.4.1.1466.115.121.1.15", new DirectoryStringConverter() )
			.put( "1.3.6.1.4.1.1466.115.121.1.5", new BinaryStringConverter() )
			.put( "1.3.6.1.4.1.1466.115.121.1.24", new TimeConverter() )
			.put( "1.3.6.1.4.1.1466.115.121.1.12", new DistinguishedNameConverter() )
			.build();
	...
	public static final ImmutableMap<Type, Converter> defaultAttributeConverters = new ImmutableMap.Builder<Type, Converter>()
			...
			.put( Integer.TYPE, new IdentityConverter<Integer>( Integer.TYPE ) )
			.put( Integer.class, new IdentityConverter<Integer>( Integer.class ) )
			.put( Short.TYPE, new IdentityConverter<Short>( Short.TYPE ) )
			.put( Short.class, new IdentityConverter<Short>( Short.class ) )
			.put( Byte.TYPE, new IdentityConverter<Byte>( Byte.TYPE ) )
			.put( Byte.class, new IdentityConverter<Byte>( Byte.TYPE ) )
			.put( Boolean.TYPE, new IdentityConverter<Boolean>( Boolean.TYPE ) )
			.put( Boolean.class, new IdentityConverter<Boolean>( Boolean.class ) )
			.put( String.class, new IdentityConverter<String>( String.class ) )
			.put( byte[].class, new IdentityConverter<byte[]>( byte[].class ) )
			.put( Name.class, new IdentityConverter<Name>( Name.class ) )
			.put( Date.class, new IdentityConverter<Date>( Date.class ) )
			.put( Long.TYPE, new IdentityConverter<Long>( Long.TYPE ) )
			.put( Long.class, new IdentityConverter<Long>( Long.class ) )
			.build();
