...
public abstract class AttributeConverter<D, O> implements Converter {
	...
	public AttributeConverter(final Class<D> directoryType,
	...
	@Override
	public final Object toDirectory(@Nullable final Object object)
	...
	@SuppressWarnings("unchecked")
	@Override
	public final Object fromDirectory(@Nullable final Object value)
			throws ConvertionException {
		if (value == null)
			return null;
	...
	public boolean equals(Object obj) {
		...
		return (this.directoryType.equals(other.directoryType) && this.objectType
