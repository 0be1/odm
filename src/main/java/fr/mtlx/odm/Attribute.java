...
public @interface Attribute {
	 ...
	 * <p>
	 * Defaults to "" in which case the Java field name is used as the LDAP
	 * attribute name.
	 * 
	 ...
	 * 
	 * @return Either <code>Type.STRING</code> to indicate a string attribute or
	 *         <code>Type.BINARY</code> to indicate a binary attribute.
	 */
	 ...
	 * <p>
	 * This optional value is typically used to affect the precision of
	 * conversion of values between LDAP and Java, see
